                        ...
                        <div class="row">
                            <div class="col-md-7 row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" 
                                        name="date_start" class="uk-input" placeholder="Дата начала" />
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label>Дата окончания</label>
                                    <input type="date" 
                                        name="date_end" class="uk-input" placeholder="Дата окончания" />
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label>Краткое описание</label>
                                    <textarea class="uk-textarea" name="body_short" rows="8" placeholder="Введите краткое описание"></textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label>Полное описание</label>
                                    <textarea class="uk-textarea" rows="8" name="body_long" placeholder="Расскажите больше об акции. Для кого она, кому подходит и так далее"></textarea>
                                </div>
                                <div class="col-md-4">
