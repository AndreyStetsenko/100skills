        ...
        <main class="main">
            <div class="container">
                ...
                <section class="section-last">
                    ...
                    @endif
                    <form action="{{ route('actions.update', $action->id) }}" 
                        method="post">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-7 row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" 
                                        value="{{ date('Y-m-d', strtotime($action->date_start)) }}"
                                        name="date_start" 
                                        class="uk-input" 
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" 
                                        value="{{ date('Y-m-d', strtotime($action->date_end)) }}"
                                        name="date_end" 
                                        class="uk-input" 
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea class="uk-textarea" name="body_short" rows="8" placeholder="Введите краткое описание">{{ $action->body_short }}</textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label>Полное описание</label>
                                    <textarea class="uk-textarea" rows="8" name="body_long" placeholder="Расскажите больше об акции. Для кого она, кому подходит и так далее">{{ $action->body_long }}</textarea>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="col-md-4 offset-md-1">
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                      ...
                                      let src;
                                      src = '{{ $action->gallery->last()->src ?? '/public/files/no-image.png' }}';
                                    ...
                                    $("#course_id").val({{ $action->course->id }}).change();
                                </script>
                            </div>
                        </div>
                    </form>
